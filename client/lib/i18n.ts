...
export const translations = {
  en: {
    ...
    currentFocusDisabledHint: '{name} is already your current focus',
    selectedFocusLabel: 'Selected focus',
  ...
  de: {
    ...
    currentFocusDisabledHint: '{name} ist bereits dein aktueller Schwerpunkt',
    selectedFocusLabel: 'Gewählter Schwerpunkt',
